...
public class RotationOfArrayAndFindIndex {
		...
		public static void main(String[] args) {
			...
			rightShift(arr);
			System.out.println("After Shifting 1st right shift:"+Arrays.toString(arr));
			rightRotation(arr);
			...
			for(int i=0;i<=arr.length-1;i++) {
				if(arr[i]==temp) {
					System.out.println("Elements found at index 3 :"+arr[3]);
					return;
